package com.example.ciclismoapp.fragments;
...
import com.example.ciclismoapp.MapaActivity;
import com.example.ciclismoapp.MostrarRutasActivity;
import com.example.ciclismoapp.R;
...
public class InformacionFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        btnclose =   vista.findViewById(R.id.BtnCloseFragmentRoute);

        btnclose.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                getFragmentManager().beginTransaction().remove(InformacionFragment.this).commit();
